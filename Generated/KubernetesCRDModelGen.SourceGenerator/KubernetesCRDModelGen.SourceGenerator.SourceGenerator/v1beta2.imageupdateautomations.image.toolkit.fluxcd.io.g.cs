...
public partial class V1beta2ImageUpdateAutomationSpecGitCheckout
{
    ...
    public required V1beta2ImageUpdateAutomationSpecGitCheckoutRef Ref { get; set; }
}
...
public partial class V1beta2ImageUpdateAutomationSpecGitCommitSigningKey
{
    ...
    public required V1beta2ImageUpdateAutomationSpecGitCommitSigningKeySecretRef SecretRef { get; set; }
}
...
public partial class V1beta2ImageUpdateAutomationSpecGitCommit
{
    ...
    public required V1beta2ImageUpdateAutomationSpecGitCommitAuthor Author { get; set; }
...
public partial class V1beta2ImageUpdateAutomationSpecGit
{
    ...
    /// <summary>Commit specifies how to commit to the git repository.</summary>
    [JsonPropertyName("commit")]
    public required V1beta2ImageUpdateAutomationSpecGitCommit Commit { get; set; }
...
public partial class V1beta2ImageUpdateAutomationSpec
{
    ...
    public required V1beta2ImageUpdateAutomationSpecSourceRef SourceRef { get; set; }
...
public partial class V1beta2ImageUpdateAutomationStatusConditions
{
    ...
    public required V1beta2ImageUpdateAutomationStatusConditionsStatusEnum Status { get; set; }
